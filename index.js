...
console.log(createMenuItem("hamburger", 15, "food"))
console.log(createMenuItem("soda", 1, "drink"))
console.log(createMenuItem("stuff", 1, "thing"))
...
export const burger = {
  ...
  discount: function(name) {
    if (name === "teacher") return 13.5;
    if (name === "student") return 13.5;
    if (name === "public") return 16.2;
  }
}
